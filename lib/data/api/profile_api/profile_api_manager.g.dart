...
class _ProfileApiManager implements ProfileApiManager {
  ...
  @override
  Future<DriverDataResponseModel?> getLoggedDriverInfo(String token) async {
    ...
    late DriverDataResponseModel? _value;
    try {
      _value = _result.data == null
          ? null
          : DriverDataResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<VehicleResponseModel?> getVehicleInfo(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<VehicleResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    try {
      _value = _result.data == null
          ? null
          : VehicleResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
